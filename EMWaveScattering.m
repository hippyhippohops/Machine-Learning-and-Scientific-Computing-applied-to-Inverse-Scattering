...
% FIGURE OUT HOW TO DRAW THE SCATTER PROPERLY
...
%Solve the harmonic analysis model for the frequency ω=4π. From the Matlab
%documentation, A HarmonicResults object contains the electric or magnetic
%field, frequency, and mesh values in a form convenient for plotting and
%postprocessing.The electric or magnetic field values are calculated at the
%nodes of the triangular or tetrahedral mesh generated by generateMesh.
%Electric field values at the nodes appear in the ElectricField property.
%Magnetic field values at the nodes appear in the MagneticField property.
...
% Note that under results, under electric field, the x and y columns store
% the real and imaginary components of the electric field
% BUT WHY IS MAGNETIC FIELD EMPTY


% So when I call this in the Method of Moments Script I get the following
% error:  Dot indexing is not supported for variables of this type. Error
% in alternateGetframe. So, I will comment out the following block of code
% first
